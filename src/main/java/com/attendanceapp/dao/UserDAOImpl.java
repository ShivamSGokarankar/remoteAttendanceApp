...
public class UserDAOImpl implements UserDAO {
    ...
    public List<User> getAllUsers() {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            TypedQuery query = session.createQuery("From com.attendanceapp.model.User", User.class);
    ...
    public User getUser(User user) throws NullPointerException, IllegalArgumentException {
        ...
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            TypedQuery query = session.createQuery("From com.attendanceapp.model.User where username =:username",
                    User.class);
